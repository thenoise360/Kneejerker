...
--
-- Host: localhost    Database: 2023_2024_bootstrapstatic    Table: game_settings
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `game_settings` (
  ...
  `featured_entries` int DEFAULT NULL,
  `percentile_ranks_1` int DEFAULT NULL,
  `percentile_ranks_5` int DEFAULT NULL,
  `percentile_ranks_10` int DEFAULT NULL,
  `percentile_ranks_15` int DEFAULT NULL,
  `percentile_ranks_20` int DEFAULT NULL,
  `percentile_ranks_25` int DEFAULT NULL,
  `percentile_ranks_30` int DEFAULT NULL,
  `percentile_ranks_35` int DEFAULT NULL,
  `percentile_ranks_40` int DEFAULT NULL,
  `percentile_ranks_45` int DEFAULT NULL,
  `percentile_ranks_50` int DEFAULT NULL,
  `percentile_ranks_55` int DEFAULT NULL,
  `percentile_ranks_60` int DEFAULT NULL,
  `percentile_ranks_65` int DEFAULT NULL,
  `percentile_ranks_70` int DEFAULT NULL,
  `percentile_ranks_75` int DEFAULT NULL,
  `percentile_ranks_80` int DEFAULT NULL,
  `percentile_ranks_95` int DEFAULT NULL,
  `percentile_ranks_90` int DEFAULT NULL,
  `percentile_ranks` int DEFAULT NULL,
