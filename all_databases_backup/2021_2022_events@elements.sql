...
--
-- Host: localhost    Database: 2021_2022_events    Table: elements
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `elements` (
  ...
  `penalties_missed_points` int DEFAULT NULL,
  `penalties_missed_value` int DEFAULT NULL,
  `penalties_saved_points` int DEFAULT NULL,
  `penalties_saved_value` int DEFAULT NULL
